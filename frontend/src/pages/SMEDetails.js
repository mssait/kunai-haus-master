...
import { IconBrandFacebook, IconBrandInstagram, IconBrandSnapchat, IconBrandX, IconLocation, IconMail, IconMan, IconMap, IconPhone, IconWoman, IconWorldWww } from '@tabler/icons-react'
                        ...
                        <Stack spacing={1}>
                            ...
                            <List>
                                <Grid container spacing={1}>
                                    ...
                                    {(data.instagram || data.facebook || data.twitter || data.snapchat) && (
                                        <Grid item xs={12}>
